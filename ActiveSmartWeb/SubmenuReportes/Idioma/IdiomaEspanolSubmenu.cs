...
{
    public class IdiomaEspanolSubmenu
    {
        public const string _titulo = "REPORTES";
        public const string _reporteActivos = "REPORTE DE ACTIVOS";
        public const string _reporteInventario = "REPORTE DE INVENTARIOS";
        public const string _reporteUbicacion = "REPORTE POR UBICACIÓN";
