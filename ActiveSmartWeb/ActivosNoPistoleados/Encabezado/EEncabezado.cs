...
namespace ActiveSmartWeb.ActivosNoPistoleados.Encabezado
{
    public class EEncabezado
    {
        ...
        public EEncabezado(int idTomaFisica, string nombre, string descripcion, DateTime fechaInicial, DateTime fechaFinal, int categoria, string nombreCategoria, int cantidadActivos, string nombreUsuario)
        {
