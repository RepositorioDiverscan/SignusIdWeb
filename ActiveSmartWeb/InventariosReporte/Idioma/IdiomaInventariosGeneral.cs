...
{
    public class IdiomaInventariosGeneral
    {
        ...
        public string Tituloinfo { get => _tituloinfo; set => _tituloinfo = value; }
        public string Subinfo { get => _subinfo; set => _subinfo = value; }
        public string ErrorDescarg { get => _ErrorDescarg; set => _ErrorDescarg = value; }
