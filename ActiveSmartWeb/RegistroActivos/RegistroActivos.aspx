                ...
                <div id="email-form" name="email-form" data-name="Email Form" method="get" class="form">
                  <div class="w-layout-grid grid-form">
                    ...
                    <div id="w-node-fa236aec-8879-8489-8b60-9146962aa33c-2106bd5d" class="form-line"><label for="name-5" class="field-label" v-cloak>{{listaidiomaRegistroActivo.FechaCompra}}</label> 
                      <div class="div-fecha"><input type="date" v-model="fechaCompra" class="text-field w-input" maxlength="80" name="FECHA-3" data-name="FECHA 3" id="FechaC" v-bind:disabled="editarcampos" :max="fechaHoy" @mouseout="ValidarFecha()"><img v-on:click="AbrirDatePicker('FechaC')" src="../images/calendar.svg" loading="lazy" alt="" class="contenedor-icono cal"></div>
                    </div>
